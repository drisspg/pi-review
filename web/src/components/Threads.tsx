...
function GitHubCommentView({ comment, commentKind, prUrl, refreshGithubActivity }: { comment: PullReviewComment | PullIssueComment; commentKind: "issue" | "review"; prUrl: string; refreshGithubActivity: () => Promise<void> }) {
